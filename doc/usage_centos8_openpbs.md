## Usage for OpenHPC 2.1 CentOS 8.3 (with Warewulf + OpenPBS)

Heading title hereinafter refers OpenHPC 2.1 (6 April 2021) [CentOS
8.3 aarch64 Install guide with Warewulf + OpenPBS][1].
...
8.3 x86_64 Install Guide (with Warewulf + OpenPBS)][2].

[1]: https://github.com/openhpc/ohpc/releases/download/v2.1.GA/Install_guide-CentOS8-Warewulf-OpenPBS-2.1-aarch64.pdf "CentOS 8.3 aarch64 Install Guide (with Warewulf + OpenPBS)"
[2]: https://github.com/openhpc/ohpc/releases/download/v2.1.GA/Install_guide-CentOS8-Warewulf-OpenPBS-2.1-x86_64.pdf "CentOS 8.3 x86_64 Install Guide (with Warewulf + OpenPBS)"
...
# Update the ARCH
[root@x86_64 ~]# wwsh vnfs set -y centos8.3-aarch64 -a aarch64
...
[root@x86_64 /]# wwsh provision set ${c_name} --vnfs=centos8.3-aarch64 --bootstrap=4.18.0-240.22.1.el8_3.aarch64 \
